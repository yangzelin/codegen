...
package ${basePackage}.${moduleName}.${functionName}.domain.dto;
...
public class ${className}DTO extends ${className}{
    ...
    <@generateSetGetMethod propertyName='start' columnClass='int' />
    <@generateSetGetMethod propertyName='end' columnClass='int' />
    <#list table.columns as column>
	<#if (column.columnType == "DATE" || column.columnType == "TIMESTAMP")>
	<#-- 输出set、get方法-->
