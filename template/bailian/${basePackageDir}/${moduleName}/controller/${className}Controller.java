...
public class ${className}Controller extends BaseController{
	...
	public Map<String, Object> query(@RequestBody BaseQueryParam<${className}DTO> para, HttpServletRequest request) throws ParseException {
		...
		if(condition != null){
			...
			<#assign propertyNameUpper = column.propertyName?cap_first>
			if(condition.get${propertyNameUpper}() != null){
				paramMap.put("${column.propertyName}", condition.get${propertyNameUpper}());
			}
			
			<#if column.columnType=="DATE" || column.columnType=="TIMESTAMP">
			if(condition.get${propertyNameUpper}Start() != null){
				paramMap.put("${column.propertyName}Start", condition.get${propertyNameUpper}Start());
			}
			
			if(condition.get${propertyNameUpper}End() != null){
				paramMap.put("${column.propertyName}End", condition.get${propertyNameUpper}End());
			}
			</#if>
			</#list>
		}
		...
		Page<${className}> pageResult = ${classNameLower}Service.selectPageListByParam(paramMap, page);
